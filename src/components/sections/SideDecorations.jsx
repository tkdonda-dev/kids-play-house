...
const decorations = [
    ...
    { id: 2, side: 'left', top: '41%', src: '/img/SideDecorations/tree-doth-left.png', alt: 'Tree Left', width: 280 },
    { id: 3, side: 'right', top: '74%', src: '/img/SideDecorations/monkey-right.png', alt: 'Monkey Right', width: 280 },
    { id: 4, side: 'left', top: '56%', src: '/img/SideDecorations/bear-in-tree-left.png', alt: 'Bear Left', width: 280 },
