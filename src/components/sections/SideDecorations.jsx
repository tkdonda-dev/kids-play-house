...
const decorations = [
    { id: 1, side: 'right', top: '9%', src: '/img/SideDecorations/black-cat-right.png', alt: 'Cat Right', width: 280 },
    { id: 1, side: 'left', top: '38%', src: '/img/SideDecorations/tree-doth-left.png', alt: 'Tree Left', width: 280 },
    { id: 2, side: 'right', top: '75%', src: '/img/SideDecorations/monkey-right.png', alt: 'Monkey Right', width: 280 },
