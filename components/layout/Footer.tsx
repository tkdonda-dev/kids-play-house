  ...
  return (
    <footer className="bg-white pt-20 border-t border-slate-50 relative overflow-hidden">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 relative z-10">
        ...
        <div className="space-y-6">
          <div className="flex items-center space-x-2">
            ...
            />
            <span className="text-2xl font-display font-bold text-slate-900">Kid's Play House</span>
          </div>
          <p className="text-slate-500 text-sm leading-relaxed">
            Kid's Play House is an early childhood education school where all children, typically aged 4 to 6, begin their learning journey.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-4 text-slate-500 text-sm">
            <li className="flex items-start">
              ...
              <span><strong className="text-primary font-bold">Address:</strong> Mota Varachha, Surat-394101</span>
            </li>
            ...
            <li className="flex items-center">
              ...
              <span><strong className="text-primary font-bold">Mail Us:</strong> infon@kidsplayhouse.com</span>
            </li>
          </ul>
        </div>
        ...
        {/* Newsletter */}
        <div>
          <h4 className="text-lg font-display font-bold mb-6 text-slate-900">Visit for Enquiry</h4>
          <p className="text-slate-500 text-sm mb-4">Visit at school or contact us for admission</p>
      ...
      <div className="bg-accent py-4 text-center text-white text-xs font-bold uppercase tracking-widest px-4">
        © 2026 Kids' Play House Nursery. All rights reserved.
      </div>
    </footer>
  );
};
